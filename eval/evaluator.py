        ...
        self.metric_dictionary = [
            {
                ...
                "metric_prompt": "Establish a revised five-point assessment scale for the hallucination detector that emphasizes precise differentiation between all levels of factual accuracy and relevance. Assign the classification labels '1', '2', '3', '4', and '5', with each level distinctly representing the degree of hallucination: No Hallucination and Complete Relevance ('1'): Outputs that are entirely accurate and fully relevant to the provided context, demonstrating complete factual accuracy and contextual alignment, offering impeccable and highly dependable content. Minimal Hallucination and High Relevance ('2'): Outputs that are mostly accurate with very few inaccuracies or minor irrelevant details, maintaining a high level of relevance to the provided context, resulting in reliable and largely correct content. Occasional Hallucination and Moderate Relevance ('3'): Outputs that contain occasional inaccuracies or slight deviations from factual information but maintain moderate relevance to the provided context, offering a generally reliable but imperfect account. Moderate Hallucination and Limited Relevance ('4'): Outputs that include several inaccuracies or fabricated details with limited relevance to the provided context, resulting in content that is partially misleading and only marginally useful. High Hallucination and Irrelevance ('5'): Outputs that fundamentally misrepresent facts or fabricate information, displaying a complete disconnect from the provided context, resulting in highly inaccurate and irrelevant content. This adjusted scale is designed to correct the prior misclassifications by ensuring clear and accurate recognition of each level of factual accuracy and relevance, thereby avoiding the underestimation of high-quality outputs and providing a fair representation for lower-quality ones."
            },
            {
